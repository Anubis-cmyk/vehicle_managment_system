        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              ...
              children:  [
                const Center(child: Text('Welcome back !',style: TextStyle(color: Colors.white,fontSize: 20),)),
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('E-mail ',style: TextStyle(color: Colors.white,fontSize: 15)),
                      Padding(
                        padding: const EdgeInsets.only(top: 10),
                        child: TextField(
                            decoration: InputDecoration(
                                errorText: _validate ? 'E-mail Can\'t Be Empty' : !_isValidEmail?'Enter valid email':null,
