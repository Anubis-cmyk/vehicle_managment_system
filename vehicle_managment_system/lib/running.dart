...
import 'single_vehicle.dart';

class RunningVehiclePage extends StatefulWidget {
  RunningVehiclePage({Key? key}) : super(key: key);
  @override
  _RunningVehiclePageState createState() => new _RunningVehiclePageState();
}
                  ...
                  children: List.generate(100, (index) {
                    return TextButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) =>  SingleVehiclePage()),
                        );
                      },
                      child: Padding(
